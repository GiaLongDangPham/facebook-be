package com.gialong.facebook.messageroom;
...
public class MessageRoomMapper {
    ...
    public MessageRoom toEntity(final MessageRoomDTO messageRoomDTO, final MessageRoom messageRoom) {
        ...
        final User createdBy = messageRoomDTO.getCreatedById() == null
                ? null
                : userRepository.findById(UUID.fromString(messageRoomDTO.getCreatedById()))
